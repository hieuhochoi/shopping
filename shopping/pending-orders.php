	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>GymShopper Cart</li>
			</ul>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">TIẾN HÀNH để thanh toán</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>không tìm thấy kết quả</h4></td>
</tr>
<?php } ?>
